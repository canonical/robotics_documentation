...
As part of [Ubuntu Pro](https://ubuntu.com/pro/beta) for Applications subscription, 
[ROS ESM](https://ubuntu.com/robotics/ros-esm) gives you a hardened and long-term supported ROS system for robots and its applications. 
...
If you are a standard or advanced customer, you also get ROS support. This provides you with a single point of contact to log ROS bugs.
...
* [Ubuntu Pro Service Description, Extended Security Maintenance (ESM) page,](https://ubuntu.com/security/esm)
* [ROS ESM Specialist service description](https://ubuntu.com/legal/ubuntu-pro-description/ros-esm-service-description)

Or, if you have specific questions, [contact us for more information](https://ubuntu.com/robotics/ros-esm#get-in-touch)!
