...
When deploying robots, the need to collect data arises sooner than expected.
One might need to visualize live or previously stored data.
...
to easily deploy applications at any scale and
...
The typical use case of {{ COS_ROB }} is for a company to
deploy a complete observability stack for a fleet of devices.

Whether deployed on self-hosted infrastructure or in the cloud,
{{ COS_ROB }} can meet all the observability needs of an organization.
...
<div style="width:75%;margin:0 auto;"><div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/1136163245?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture; clipboard-write" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="ROSCon presentation: COS for Robotics"></iframe></div></div><script src="https://player.vimeo.com/api/player.js"></script>
