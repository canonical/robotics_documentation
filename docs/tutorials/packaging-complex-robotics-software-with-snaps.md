...
>What we achieved here is perfectly working. If you would like to learn more about how to debug possible issues, please refer to the [How-to Guide: Debugging Snap Applications](/docs/how-to-guides/debugging-snap-applications).
